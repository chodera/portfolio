...
output:
  html_document:
    df_print: paged
image: assets/images/cinema_opt.jpg
normal: true
show: true
logo: r
---
...
Get the full code [here](https://github.com/chodera/chodera.github.io/blob/master/assets/projects/6.%20Cinemas%20in%20Strasbourg/cinemas_stras.R){:target="_blank"}.
