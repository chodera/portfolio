...
Ever wandered around a city desperately looking for a public toilet? Fear not, the open data movement is here to help. The city of Strasbourg recently opened a new [open data portal](https://data.strasbourg.eu/pages/accueil/){:target="_blank"} and while checking their available data sets I came across the one about public toilets. I guess every city should leak information about their public toilets.
...
Get the code [here](https://github.com/chodera/chodera.github.io/blob/master/assets/projects/4_public_toilets_strasbourg/strasbourg_toilettes.R){:target="_blank"}.
